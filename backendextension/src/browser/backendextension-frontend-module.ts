...
import { BackendextensionCommandContribution} from './backendextension-contribution';

export default new ContainerModule(bind => {
    bind(CommandContribution).to(BackendextensionCommandContribution).inSingletonScope();
